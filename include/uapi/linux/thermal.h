...
enum thermal_genl_attr {
	...
	THERMAL_GENL_ATTR_EVENT,                /* Original attribute */
...
enum thermal_genl_event {
	...
	THERMAL_GENL_EVENT_THRESHOLD_FLUSH,	/* All thresholds have been deleted */
...
enum thermal_genl_cmd {
	...
	THERMAL_GENL_CMD_EVENT,                 /* Original command from kernel */
